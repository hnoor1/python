...
c = math.hypot(korgus,kaugus) #sama mis eelmine c, lihtsalt funktsiooniga
...
turtle.left(90+nurk) #90+nurk -> 90 selleks, et keeraks ning nurk juurde, et arvestaks 53 kraadi juurde
turtle.fd(c*koef)
