...
print(f"{kogus} raamatu hind soodustusega on {summa:.2f} €.") #.2f ümardab 2 komakohta
...
# Programm peaks küsima kasutajalt kahe aiaosa pikkused meetrites ja seejärel arvutama aia kogupikkuse. (külg a ja külg b)
# Väljasta lause, kasutades f-string vormindamist.
# Näide:
# Kasutaja sisestab: 4 ja 5
# Programm väljastab: Aia kogupikkus on 18 meetrit.

#kasutaja sisestus ja muudan täisarvuks (st int-iga tuli normaalne vastus

a = int(input("Lisa külg 1: "))
b = int(input("Lisa külg 2: "))
p = (a+b)*2
print(f"Aia kogupikkus külgedega {a}m ja {b}m on kokku {p} meetrit.")
